        ...
        <div className="text-center">
          <Link
            ...
            style={{
              ...
              backgroundImage:
                "linear-gradient(#272727, #272727), linear-gradient(to bottom, #FF7950, #C0350A)",
              backgroundOrigin: "border-box",
              backgroundClip: "padding-box, border-box",
            }}
          >
            <Image
              src="/Frame 1618872409.png"
                ...
                <li key={item.name}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <span className="font-bricolage text-[16px]">
                        {item.name}
                      </span>
                    </div>
                    {item.badge && (
      ...
      <div className="px-3 mt-auto">
        ...
        <div className="mx-2 px-3 py-3 bg-[#F0F0F0] rounded-[16px] flex items-center gap-3 border border-[#F3F4F6]">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="text-[16px] font-bold text-[#303030] truncate">
              Delhi Public School
            </h4>
            <p className="text-[14px] text-[#5E5E5E] truncate">
              Bokaro Steel City
            </p>
          </div>
        </div>
